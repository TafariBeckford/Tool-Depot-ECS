...
<?php include('includes/header.php');?>
		...
		<div class="hero">
         <img src="https://contentgrid.homedepot-static.com/hdus/en_US/DTCCOMNEW/fetch/Category_Pages/Tools/Power_Tools/Tools-Power-Tools-9-6-hero-12g-v4.jpg" class="stretchy">
             <div class="hero-text">
                 <h1 class="PowerToolfont">Power Tools</h1>
</div>
...
<div id="store" class="col-md-9">
	...
	<div class="row">
		<?php
		$sql = "SELECT tools.ToolName,tools.ToolBrand,tools.ToolOverview,tools.PricePerDay,tools.ToolCategory,tools.id,tools.Vimage1 from tools WHERE Toolcategory='Power Tools' ";
			...
			foreach ($results as $row) {
				echo '<div class="col-md-4 col-xs-6">
						<div class="product">
							...
							<a href=""><img src="./admin/img/tools/' . $row['Vimage1'] . '" alt="image" width=200 height=200></a>
