...
?>  
                       ...
                       <div class="product">
											...
											<div class="product-img">
                                                <a href=""><img src="./admin/img/tools/<?php echo htmlentities($result->Vimage1);?>" alt="image" width=200 height=200></a>
											</div>
											<div class="product-body">
												<p class="product-category"><?php echo htmlentities($result->ToolBrand);?></p>
												<h3 class="product-name"><a href="product.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->ToolName);?></a></h3>
												<h4 class="product-price">$<?php echo htmlentities($result->PricePerDay);?><del class="product-old-price">$990.00</del></h4>
