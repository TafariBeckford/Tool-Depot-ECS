...
<?php include('includes/header.php');?>
		...
		<div class="hero">
         <img src="https://contentgrid.homedepot-static.com/hdus/en_US/DTCCOMNEW/fetch/Category_Pages/Tools/Power_Tools/Tools-Power-Tools-9-6-hero-12g-v4.jpg" class="stretchy">
             <div class="hero-text">
                 <h1 class="PowerToolfont">Tool Storage</h1>
</div>
					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
							...
							<div class="col-md-4 col-xs-6">
                                <?php $sql = "SELECT tools.ToolName,tools.ToolBrand,tools.ToolOverview,tools.PricePerDay,tools.ToolCategory,tools.id,tools.Vimage1 from tools WHERE Toolcategory='Tool Storage' ";
