					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
							...
							<div class="col-md-4 col-xs-6">
                                <?php $sql = "SELECT tools.ToolName,tools.ToolBrand,tools.ToolOverview,tools.PricePerDay,tools.ToolCategory,tools.id,tools.Vimage1 from tools WHERE Toolcategory='Power Tools' ";
