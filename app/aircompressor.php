...
<?php include('includes/header.php');?>
 ...
 <div class="hero">
        <img src="https://contentgrid.homedepot-static.com/hdus/en_US/DTCCOMNEW/fetch/Category_Pages/Tools/Air_Compressors/ACNG-HERO-DSKTP.jpg" alt="Air Compressors, Nail Guns &amp; Air Tools" class="stretchy">
             <div class="hero-texts">
                 <h1 class="Airfont">Air Compressors & Acessories</h1>
</div>
					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
							...
							<div class="col-md-4 col-xs-6">
                                <?php $sql = "SELECT tools.ToolName,tools.ToolBrand,tools.ToolOverview,tools.PricePerDay,tools.ToolCategory,tools.id,tools.Vimage1 from tools WHERE Toolcategory='Air Compressors & Ac' ";
